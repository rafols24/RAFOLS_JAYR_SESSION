...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Lato|Open+Sans|PT+Sans|Roboto|Roboto+Slab|Titillium+Web" rel="stylesheet"><style class="cp-pen-styles">* { box-sizing:border-box; }
</head>
<style>
body {
...
<body>
  ...
  <div class="background2"></div>
    ...
    <form action="" method="post">
      <div class="group">
        <input type="text" name="username" class="used"><span class="highlight"></span><span class="bar"></span>
      ...
      <button type="submit" name="submit" class="buttonui "> <span> Log in </span>
