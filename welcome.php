<?php
    ...
    if(isset($_SESSION['username']))
    {
        ...
        echo '<br>';
        echo '<center><a href="logout.php?logout" class="btn btn-info" role="button">Log Out</a></center>';
        echo'<br>';
